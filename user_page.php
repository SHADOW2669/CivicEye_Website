...
<div class="mobile-nav-menu" id="mobileNavMenu" aria-hidden="true">
    ...
    <?php if (isset($_SESSION['email'])): ?>
        <a href="logout.php" class="logout-btn-link"> <button class="btn-base btn-nav-action logout-btn">LOGOUT</button> </a>
    <?php endif; ?>
</div>
    ...
    <div class="dashboard-container">
        ...
        <div class="violations-grid" id="violationsGrid" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="violation-card">
             ...
             <div class="violation-card">
                <img src="https://placehold.co/400x220/111827/7BD3EA?text=Violation+Image+6" alt="Violation Screenshot 6" onerror="this.style.backgroundColor='#333'; this.alt='Image load error'; this.src='https://placehold.co/400x220/333333/cccccc?text=Error';">
                <div class="violation-details">
                    <h4>Violation: No Helmet</h4>
