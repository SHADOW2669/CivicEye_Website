...
<head>
    ...
    <link rel="stylesheet" href="conact-us.css" />
                ...
                <div class="contact-form">
                    ...
                    <form id="contactForm">
                        ...
                        <p class="github-disclaimer">
                            Clicking "Open GitHub Issue" will redirect you to GitHub to create a new issue pre-filled
        ...
        if (!overlay) console.warn("- #overlay missing");
            ...
            if (contactForm) {
                contactForm.addEventListener('submit', function (event) {
                    ...
                    // Create Issue Body (using Markdown)
